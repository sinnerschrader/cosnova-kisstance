...
(function () {
  ...
  let trafficMediumPattern;
  let trafficCampaignPattern;
  let trafficSourcePattern;
  let campaignGclid;

  if (document.location.search!='') {
    // Please change the URL strings below to choose your traffic parameters
    let mediumParName = 'utm_medium';
    let campaignParName = 'utm_campaign';
    let sourceParName = 'utm_source';
  ...
  if (typeof CS_CONF === 'undefined') {
    ...
    let mt = document.createElement('script'); mt.type = 'text/javascript'; mt.async = true;
